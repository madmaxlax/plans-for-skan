...
export const RECURRING: Recurring[] = [
  ...
  // ── Lake / cruises ────────────────────────────────────────────────────────
  {
    kind: "recurring",
    id: "midlakes-lunch",
    title: "Mid-Lakes Navigation lunch cruise (2hr buffet)",
    daysOfWeek: ["tue", "wed", "fri"],
    timeStart: "11:00am",
    seasonStart: "2026-06-01",
    location: "Clift Park pier",
    notes: "$56 adults / $34 kids. Book ahead — sells out.",
    link: "https://midlakesnavigation.com",
    category: "lake",
    accent: "lake",
  },
  {
    kind: "recurring",
    id: "midlakes-dinner-frisat",
    title: "Mid-Lakes Navigation dinner cruise",
    daysOfWeek: ["fri", "sat"],
    timeStart: "6:00pm",
    seasonStart: "2026-06-01",
    location: "Clift Park pier",
  ...
  {
    kind: "recurring",
    id: "auburn-y-pickleball-tt",
    title: "Pickleball drop-in",
    daysOfWeek: ["tue", "thu"],
    location: "Auburn YMCA",
    notes: "$10 non-member; $5 with Skan Pickleball Club.",
    category: "sports",
    accent: "lake",
  },
  {
    kind: "recurring",
    id: "auburn-y-pickleball-club",
    title: "Skan Pickleball Club @ Auburn Y",
